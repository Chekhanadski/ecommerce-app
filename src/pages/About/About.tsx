...
const teamMembers: TeamMember[] = [
  {
    ...
    photo:
      'https://media.licdn.com/dms/image/D4D03AQF9X9wMTDc4kg/profile-displayphoto-shrink_400_400/0/1686626382909?e=1723680000&v=beta&t=6Sbb0kzto0kwLAd-C4wF6LsQzqiOvJaEtBI7ATEZ_Sg'
  },
  {
  ...
  return (
    <div className={styles.teamMember}>
      ...
      <div className={styles.teamMemberDetails}>
        ...
        <p>{member.bio}</p>
        <p>
          <strong>Contributions to the project:</strong>
        </p>
        <ul>
  ...
  return (
    <main className={styles.mainSection}>
      ...
      <div className={styles.collaborationSuccess}>
        ...
        <p>
          The success of our team is the result of effective collaboration and a shared commitment to excellence. Under
          the leadership of our mentor, Semion Krapivin, we employed agile methodologies to ensure continuous
        ...
        <p>
          ...
          the product we have built. We look forward to continuing to innovate and create solutions that make a
          difference.
        </p>
      </div>
    </main>
